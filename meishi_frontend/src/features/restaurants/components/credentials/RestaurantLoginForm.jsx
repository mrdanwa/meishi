...
export default function RestaurantLoginForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      handleError(new Error("Invalid username or password"));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-sky-100 flex flex-col justify-center p-4">
      ...
      <div className="mt-8 w-full max-w-md mx-auto">
        <div className="bg-white/70 backdrop-blur-lg py-8 px-6 shadow-xl shadow-blue-500/10 rounded-xl border border-white/20">
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
